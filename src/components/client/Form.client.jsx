...
const Form = ({
  ...
  return (
    <section className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-slate-700/20 h-full w-full">
      <div className="fixed top-0 left-0 right-0 bottom-0 z-50 lg:flex lg:items-center backdrop-blur-md overflow-y-scroll md:overflow-hidden">
        <form
